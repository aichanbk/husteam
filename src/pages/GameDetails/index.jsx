...
const GameDetails = () => {
  ...
  const { id } = useParams();
  const url = `https://api.rawg.io/api/games/${id}?key=7d018c86c6824c67951eab24b743c007`;
  ...
  const {
    ...
    queryFn: () =>
      fetch(
        `https://api.rawg.io/api/games/${id}/screenshots?key=7d018c86c6824c67951eab24b743c007`
      ).then((res) => res.json()),
  });
